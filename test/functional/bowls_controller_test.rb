...
class BowlsControllerTest < ActionController::TestCase
  ...
  test "should create bowl" do
    assert_difference('Bowl.count') do
      post :create, :bowl => { :colour => @bowl.colour, :created => @bowl.created, :id => @bowl.id, :modified => @bowl.modified, :name => @bowl.name, :userid => @bowl.userid }
    end
  ...
  test "should update bowl" do
    put :update, :id => @bowl, :bowl => { :colour => @bowl.colour, :created => @bowl.created, :id => @bowl.id, :modified => @bowl.modified, :name => @bowl.name, :userid => @bowl.userid }
    assert_redirected_to bowl_path(assigns(:bowl))
  end
