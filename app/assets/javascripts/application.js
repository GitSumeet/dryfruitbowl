...
$(document).ready(function() {
	...
	$('#modal').on('click', function() { 
		new Messi('<h3>The DryFruit Bowl Project</h3><p class="tertiary-secondary-text">The project idea came about five months ago when I started having bowl-full of \
		 ...
		 Ruby 1.8.7<br/>Rails 3.2.7<br/>JQuery 1.8.3<br/>Metro UI CSS<br/>Messi Message Plugin.<br/>It was built using Aptana Studio 3 IDE on a Ubuntu 12.04 LTS Platform<br/>\
		 <br/>\
		 ...
		 I have plans to add a feedback form to the project. Until then please send in your feedback and suggestions to (abhimanyu@netjoos.com)<br/></p></div>', 
